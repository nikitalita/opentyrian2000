\doxysection{starlib.\+h}
\hypertarget{starlib_8h_source}{}\label{starlib_8h_source}\index{src/starlib.h@{src/starlib.h}}
...
\DoxyCodeLine{00019\ \textcolor{preprocessor}{\#ifndef\ STARLIB\_H}}
\DoxyCodeLine{00020\ \textcolor{preprocessor}{\#define\ STARLIB\_H}}
\DoxyCodeLine{00021\ }
\DoxyCodeLine{00022\ \textcolor{preprocessor}{\#include\ "{}opentyr.h"{}}}
\DoxyCodeLine{00023\ }
\DoxyCodeLine{00024\ \textcolor{keywordtype}{void}\ JE\_starlib\_main(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00025\ \textcolor{keywordtype}{void}\ JE\_wackyCol(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00026\ \textcolor{keywordtype}{void}\ JE\_starlib\_init(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00027\ \textcolor{keywordtype}{void}\ JE\_resetValues(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00028\ \textcolor{keywordtype}{void}\ JE\_changeSetup(JE\_byte\ setupType);}
\DoxyCodeLine{00029\ \textcolor{keywordtype}{void}\ JE\_newStar(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ STARLIB\_H\ */}\textcolor{preprocessor}{}}
