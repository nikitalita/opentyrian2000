...
LOCAL_MODULE := omp
LOCAL_SRC_FILES := $(LOCAL_PATH)/lib/$(APP_ABI)/libomp.so
...
LOCAL_LDLIBS := -lGLESv1_CM -lGLESv2 -lOpenSLES -llog -landroid -lSDL2_net -lSDL2_mixer_ext -lmidiproc -lc++ -lc++abi
LOCAL_SHARED_LIBRARIES := SDL2 fluidsynth c++_shared omp
