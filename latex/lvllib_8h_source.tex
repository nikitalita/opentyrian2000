\doxysection{lvllib.\+h}
\hypertarget{lvllib_8h_source}{}\label{lvllib_8h_source}\index{src/lvllib.h@{src/lvllib.h}}
...
\DoxyCodeLine{00019\ \textcolor{preprocessor}{\#ifndef\ LVLLIB\_H}}
\DoxyCodeLine{00020\ \textcolor{preprocessor}{\#define\ LVLLIB\_H}}
\DoxyCodeLine{00021\ }
\DoxyCodeLine{00022\ \textcolor{preprocessor}{\#include\ "{}opentyr.h"{}}}
\DoxyCodeLine{00023\ }
\DoxyCodeLine{00024\ \textcolor{keyword}{typedef}\ JE\_longint\ JE\_LvlPosType[43];\ \textcolor{comment}{/*\ [1..42\ +\ 1]\ */}}
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00026\ \textcolor{keyword}{extern}\ JE\_LvlPosType\ lvlPos;}
\DoxyCodeLine{00027\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{char}\ levelFile[13];\ \textcolor{comment}{/*\ string\ [12]\ */}}
\DoxyCodeLine{00028\ \textcolor{keyword}{extern}\ JE\_word\ lvlNum;}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{keywordtype}{void}\ JE\_analyzeLevel(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00031\ }
\DoxyCodeLine{00032\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ LVLLIB\_H\ */}\textcolor{preprocessor}{}}
